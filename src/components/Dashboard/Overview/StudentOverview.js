...
import { FaBook, FaClipboard, FaPollH, FaCog } from 'react-icons/fa'
...
const StudentOverview = () => {
  ...
  return (
    <div className='bg-gray-100 min-h-screen py-8 rounded shadow-xl border'>
      <h1 className='text-3xl font-semibold mb-8 border-b border-gray-200 pb-4 px-4'>Student Dashboard</h1>
